...
/**
 * Navigation Testing Script (Playwright)
        ...
        const tests = [
            {
                ...
                test: async () => {
                    ...
                    const resourcesMenu = await this.page.locator('.nav-item-dropdown').first();
                    if (!(await resourcesMenu.count())) {
                    ...
                    // Wait for dropdown to appear with proper timing
                    await this.page.waitForTimeout(300); // Allow time for hover transition

                    // Check if dropdown is visible
                    const isVisible = await this.page.evaluate(() => {
                        const submenu = document.querySelector('.nav-submenu');
                        const styles = window.getComputedStyle(submenu);
                        return submenu && styles.opacity === '1' && styles.visibility === 'visible';
                    });
                    ...
                    if (!isVisible) {
                        ...
                        const debugInfo = await this.page.evaluate(() => {
                            ...
                            return {
                                ...
                                parentHover: dropdown ? dropdown.matches(':hover') : false
                            };
                        });
                        throw new Error(`Dropdown menu not visible after hover. Debug: ${JSON.stringify(debugInfo)}`);
                    }

                    // Check dropdown items
                    const dropdownItems = await this.page.locator('.nav-sublink').count();
                    if (dropdownItems === 0) {
                        throw new Error('No dropdown items found');
                    }

                    return `Dropdown menu shows ${dropdownItems} items`;
                }
            },
            {
                ...
                test: async () => {
                    ...
                    await this.page.locator('.nav-item-dropdown .nav-link[aria-haspopup="true"]').first().focus();
                    ...
                    await this.page.waitForSelector('.nav-submenu[aria-hidden="true"]', { timeout: 2000 });
            ...
            },
            {
                ...
                test: async () => {
                    ...
                    await this.page.waitForSelector('.nav-submenu', { state: 'visible', timeout: 2000 });
            ...
            const tests = [
                {
                    ...
                    test: async () => {
                        ...
                        const toggle = await this.page.locator('#mobile-menu-toggle');
        ...
        const tests = [
            {
                ...
                test: async () => {
                    ...
                    const themeToggle = await this.page.locator('#theme-toggle');
        ...
        const tests = [
            ...
            },
            {
                ...
                test: async () => {
                    ...
                    await this.page.locator('#theme-toggle').focus();
            ...
            },
            {
                ...
                test: async () => {
                    ...
                    const liveRegion = await this.page.locator('#live-region');
